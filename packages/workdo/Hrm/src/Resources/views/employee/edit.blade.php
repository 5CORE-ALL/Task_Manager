                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            {{ Form::label('state', __('Training Link'), ['class' => 'form-label']) }}
                                            <div class="form-icon-user">
                                        ...
                                        <div class="form-group col-md-6">
                                            {{ Form::label('city', __('Forms Link'), ['class' => 'form-label']) }}
                                            <div class="form-icon-user">
                                                {{ Form::text('city', null, ['class' => 'form-control', 'placeholder' => __('Enter Forms')]) }}
                                            </div>
