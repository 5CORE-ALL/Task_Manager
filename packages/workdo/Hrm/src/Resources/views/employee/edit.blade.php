                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            {{ Form::label('city', __('Incentive Link'), ['class' => 'form-label']) }}
                                            <div class="form-icon-user">
                                                {{ Form::text('city', null, ['class' => 'form-control', 'placeholder' => __('Enter Incentive Link')]) }}
                                            </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <p class="text-danger d-none" id="{{ 'training_validation' }}">
                                                {{ __('This field is required.') }}</p>
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <p class="text-danger d-none" id="{{ 'sop_guidelines_validation' }}">
                                                {{ __('This field is required.') }}</p>
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <p class="text-danger d-none" id="{{ 'reports_validation' }}">
                                                {{ __('This field is required.') }}</p>
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <p class="text-danger d-none" id="{{ 'kpi_validation' }}">
                                                {{ __('This field is required.') }}</p>
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <p class="text-danger d-none" id="{{ 'checklist_rr_validation' }}">
                                                {{ __('This field is required.') }}</p>
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <p class="text-danger d-none" id="{{ 'checklist_sr_rr_validation' }}">
                                                {{ __('This field is required.') }}</p>
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <p class="text-danger d-none" id="{{ 'checklist_general_validation' }}">
                                                {{ __('This field is required.') }}</p>
                                        </div>
                                    </div>
                                </div>
