        ...
        if (Auth::user()->isAbleTo('employee create')) {
            ...
            $employee = Employee::create(
                [
                    ...
                    'sop_guidelines' => $request['sop_guidelines'],
                    'reports' => $request['reports'],
                    'kpi' => $request['kpi'],
                    'checklist_rr' => $request['checklist_rr'],
                    'checklist_sr_rr' => $request['checklist_sr_rr'],
                    'checklist_general' => $request['checklist_general'],
