...
Route::middleware(['web','auth','verified','PlanModuleCheck:Taskly'])->group(function ()
{
    ...
    Route::post('projects/{id}/task-board/{taskID}/status-update',[ProjectController::class,'taskStatusUpdate'])->name('tasks.update.status');
    ...
    Route::get('project/task-track', [ProjectController::class,'taskTracklist'])->name('projecttask.track');
        ...
        Route::get('/tasks/staging/get-tasks/{event_id}', [ProjectController::class, 'StagingGetTasks'])->name('tasks.staging.get.tasks');
