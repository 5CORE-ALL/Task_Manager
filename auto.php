...
if (isset($_POST['submit'])) {
    ...
    foreach ($data as $row) {
        ...
        $sql = "INSERT INTO automate_tasks (`group`, title, assignor, assign_to, schedule_type, link1, link2)
                VALUES ('{$values['group']}', '{$values['title']}', '{$values['assignor']}', '{$values['assign_to']}', '{$values['schedule_type']}', 
