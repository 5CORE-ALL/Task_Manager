    ...
    public function run()
    {
        ...
        // admin settings
            ...
            $admin_setting = [
                ...
                "title_text" => !empty(env('APP_NAME')) ? env('APP_NAME') : '5CoreHrms Dash',
                "footer_text" => "Copyright © ".(!empty(env('APP_NAME')) ? env('APP_NAME') : '5CoreHrms Dash'),
                "landing_page" => "on",
                "site_rtl" => "off",
                "cust_darklayout" => "off",
                "site_transparent" => "on",
                ...
                "meta_title" => "5CoreHrms Dash SaaS - Open Source ERP with Multi-Workspace",
                "meta_keywords" => "5CoreHrms Dash,SaaS solution,Multi-workspace functionality, Cloud-based access,Scalability,Multi-addons,Collaboration tool,Data management,Business productivity,Operational effectiveness",
                "meta_description" => "Discover the efficiency of Dash, a user-friendly web application by 5CoreHrms. Streamline project management, organize tasks, collaborate seamlessly, and track progress effortlessly. Boost productivity with Dash's intuitive interface and comprehensive features. Revolutionize your project management process today. Try Dash!",
