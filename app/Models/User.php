    ...
    public static function CompanySetting($id = null,$workspace_id = null)
    {
        ...
        if(!empty($id))
        {
            ...
            $company_setting = [
                ...
                "title_text" => !empty($admin_settings['title_text']) ? $admin_settings['title_text'] : "5CoreHrms",
                "footer_text" => !empty($admin_settings['footer_text']) ? $admin_settings['footer_text'] :"Copyright © 5CoreHrms",
