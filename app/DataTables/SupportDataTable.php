...
class SupportDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('links', function (HelpdeskTicket $ticket) {

                $links = '';
                if ($ticket->link1) {
                    $links .= '<a href="' . $ticket->link1 . '" target="_blank" class="mx-1" data-bs-toggle="tooltip" title="' . $ticket->link1 . '">
            ...
            ->rawColumns(['ticket_id', 'created_by', 'category', 'status', 'action','links']);
    }
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('links')->title(__('Links')),
