...
class ReportController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('projects.Report.report', compact('forms'));
    }

    /**
     * Store a new report form (AJAX).
     */
    public function store(Request $request)
    {
        $form = ReportForm::create($request->all());
        return response()->json(['success' => true, 'form' => $form]);
    }

    /**
     * Update the specified report form (AJAX).
     */
    public function update(Request $request, $id)
    {
        $form = ReportForm::findOrFail($id);
        $form->update($request->all());
        return response()->json(['success' => true, 'form' => $form]);
    }

    /**
     * Delete the specified report form (AJAX).
     */
