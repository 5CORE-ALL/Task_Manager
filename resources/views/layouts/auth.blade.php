...
|        {{ !empty($admin_settings['title_text']) ? $admin_settings['title_text'] : config('app.name', 'WorkDo') }}</title>
    ...
    #newFeaturesModal .list-group-item {
        padding: 0.75rem 1.25rem;
        border-left: none;
        border-right: none;
    }
    
    #newFeaturesModal .list-group-item:before {
        content: "✓";
...
<body class="{{ $themeColor }}">
    <div class="custom-login">
        ...
        <div class="custom-login-inner">
            ...
            <!--                    <img src="{{asset('images/HR5LOGO.png')}}{{'?'.time()}}" alt="{{ config('app.name', '5coreHrms') }}" class="navbar-brand-img auth-navbar-brand">-->
            <!--                </a>-->
            <!--            </div>-->
                ...
                <div class="auth-footer">
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                                <span>© {{ date('Y') }}
                                    <a href="https://5core.com/" target="_blank"
                                        style="font-weight: bold;  color: black; padding: 2px 5px; text-decoration: none; border-radius: 3px;">
                                        5CORE
                                    </a> Developed By 5core Developers
                                </span>
