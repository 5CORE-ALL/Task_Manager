    ...
    <div class="d-flex">
        ...
        @permission('task create')
            <a class="btn btn-sm btn-primary me-2 add-task" data-ajax-popup="true" data-size="lg" data-title="{{ __('Create New Task') }}"
                data-url="{{ route('tasks.create') }}" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="{{ __('Create a new task with full details and options') }}"><i
                    ...
                    <div class="col-md-1">
                        <div class="card text-white bg-info mb-3">
                            <div class="card-body text-center">
                                ...
                                <h2 class="card-text" id="pending-count">{{ $pendingTask }}</h2>
                            </div>
                        </div>
                    </div>
                     <div class="col-md-1">
                        <div class="card text-white bg-danger mb-3">
                            <div class="card-body text-center">
                                ...
                                <h2 class="card-text" id="overdue-count">{{ $overdueTask }}</h2>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-1">
                        <div class="card text-white bg-warning mb-3">
                            <div class="card-body text-center">
                                ...
                                <h2 class="card-text" id="total_eta">0</h2>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-1">
                        <div class="card text-white bg-info mb-3">
                            <div class="card-body text-center">
                                ...
                                <h2 class="card-text" id="total_atc">0</h2>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-1">
                        <div class="card text-white bg-success mb-3">
                            <div class="card-body text-center">
                                ...
                                <h2 class="card-text" id="completed-count">{{ $competeTask }}</h2>
                                <!--<button class="btn btn-sm btn-light mt-2" id="today-graph-btn" onclick="showTodayGraph()" disabled>-->
                                <!--    <i class="ti ti-chart-line"></i> Today's Graph-->
                                <!--</button>-->
                            </div>
                        </div>
                    </div>
                    <div class="col-md-1">
                        <div class="card text-white bg-warning mb-3" id="etc-card">
                            <div class="card-body text-center">
                                <h5 class="card-title">D ETC</h5>
                                <h2 class="card-text" id="filtered-etc-count">0</h2>
                                <!--<small class="opacity-75">Estimated Hours</small>-->
                            </div>
                        </div>
                    </div>
                    <div class="col-md-1">
                        <div class="card text-white bg-info mb-3" id="atc-card">
                            <div class="card-body text-center">
                                <h5 class="card-title">D ATC</h5>
                                <h2 class="card-text" id="filtered-atc-count">0</h2>
                                <!--<small class="opacity-75">Actual Hours</small>-->
                            </div>
                        </div>
                    </div>
                    <div class="col-md-1">
                        <div class="card text-white bg-danger mb-3" id="urgent-etc-card">
                            <div class="card-body text-center">
                                <h5 class="card-title">U ETC</h5>
                                <h2 class="card-text" id="urgent-etc-count">0</h2>
                                <!--<small class="opacity-75">Urgent Tasks ETC</small>-->
                            </div>
                        </div>
                    </div>
                      <div class="col-md-1">
                        <div class="card text-white bg-secondary mb-3" id="graph-card" style="opacity: 0.5; cursor: not-allowed;">
                            <div class="card-body text-center">
                                <button class="btn btn-sm btn-light mt-2" id="graph-btn" disabled onclick="showGraphModal()">
                                    <i class="ti ti-chart-bar"></i> Graph
                                </button>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-1">
                        <div class="card text-white bg-purple mb-3" id="teamlogger-card">
                            <div class="card-body text-center">
                                <h5 class="card-title">T logger</h5>
                                <h2 class="card-text" id="teamlogger-hours">0</h2>
                    ...
                    <div class="col-md-1">
                        <div class="card text-white bg-success mb-3" id="month-card" style="cursor: pointer; transition: transform 0.2s;">
                            <div class="card-body text-center">
                                ...
                                <h2 class="card-text" id="current-month">{{ date('M') }}</h2>
                                <!--<small class="opacity-75">Click to change</small>-->
                            </div>
                        </div>
                    </div>
    ...
    @push('scripts')
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                // Month card click handler to cycle through months
...
// Update the AJAX data to include toggle filter
            ...
            // Function to cycle through months
            function cycleMonth() {
                ...
                // Go to next month, wrap around to January after December
                const nextMonthIndex = (currentMonthIndex + 1) % 12;
                const nextMonth = monthNames[nextMonthIndex];
                
                // Update the month display
                $('#current-month').text(nextMonth);
                
                // Update Teamlogger data for the new month
                loadTeamloggerData();
                
                // You can also update other data here if needed
                console.log('Switched to month:', nextMonth);
            }
            ...
            async function loadTeamloggerData() {
                try {
                    ...
                    const currentMonth = $('#current-month').text(); // Get current month from the card
                    ...
                    if (currentMonth) {
                        ...
                        if (currentMonthIndex !== -1 && currentMonthIndex !== actualCurrentMonth) {
                            // If showing a different month, use custom date range
                            dateFilter = 'custom';
                            const year = new Date().getFullYear();
                            const startDate = new Date(year, currentMonthIndex, 1).toISOString().split('T')[0];
                            const endDate = new Date(year, currentMonthIndex + 1, 0).toISOString().split('T')[0];
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (response.success) {
                                ...
                                const displayValue = Math.floor(response.activeHours || 0);
        ...
        <script>
            $(document).ready(function () {
             ...
             $(document).on("click", ".task-checkbox", function() {
                ...
                if (selectedIds.length > 0) {
                    $('#delete-btn, #duplicate-btn, #change-assignor-btn, #change-assignee-btn, #change-etc-btn, #change-date-btn, #change-priority-btn').removeAttr('disabled');
                } else {
                    $('#delete-btn, #duplicate-btn, #change-assignor-btn, #change-assignee-btn, #change-etc-btn, #change-date-btn, #change-priority-btn').attr('disabled', 'disabled');
                }
            });
                ...
                function getDoneTaskData() {
                    ...
                    $.ajax({
                        ...
                        data: {
                            ...
                            assignor_name: $('#assignor_name').val() || [],
                            date_filter: 'this_month', // Use this_month filter to get current month data
                            group_name: $('#group_name').val(),
                            task_name: $('#task_name').val()
                        ...
                        success: function(data) {
                            ...
                            if(data.is_success) {
                                ...
                                $("#filtered-etc-count").html(data.data.total_eta_hours || 0);
                                $("#filtered-atc-count").html(data.data.total_atc_hours || 0);
                            } else {
...
// Function to handle assignee update
window.handleAssigneeUpdate = function() {
    ...
    console.log('=== Update Assignee Function Called ===');
...
$(document).ready(function() {
    ...
    // Approach 1: Direct click handler with event delegation
    $(document).on('click', '#update-assignee-btn', function(e) {
        e.preventDefault();
        e.stopPropagation();
        console.log('Click event triggered on #update-assignee-btn');
        return handleAssigneeUpdate();
    });

    // Approach 2: Form submit handler (in case button triggers form submit)
    $(document).on('submit', '#change-assignee-form', function(e) {
        e.preventDefault();
        e.stopPropagation();
    ...
    // Approach 3: Attach handler when modal is shown
    $('#change-assignee-modal').on('shown.bs.modal', function() {
        console.log('Modal shown - attaching assignee update handler');
        $('#update-assignee-btn').off('click').on('click', function(e) {
            e.preventDefault();
            e.stopPropagation();
            console.log('Modal-shown handler triggered');
            return handleAssigneeUpdate();
        });
    });
