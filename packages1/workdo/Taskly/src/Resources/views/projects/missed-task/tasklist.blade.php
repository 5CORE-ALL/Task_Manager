        ...
        <script>
            $(document).ready(function () {
             ...
             $(document).on("click", ".task-checkbox", function() {
                ...
                if (selectedIds.length > 0) {
                    $('#delete-btn, #duplicate-btn, #change-assignor-btn, #change-assignee-btn').removeAttr('disabled');
                } else {
                    $('#delete-btn, #duplicate-btn, #change-assignor-btn, #change-assignee-btn').attr('disabled', 'disabled');
                }
            });
