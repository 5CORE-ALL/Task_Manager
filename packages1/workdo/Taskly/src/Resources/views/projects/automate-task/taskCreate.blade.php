               ...
               <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6">
                 ...
                 <div class="form-group col-md-6">
                    ...
                    <div class="image-upload-preview" id="upload-area"
                        style="text-align: center; border: 2px dashed #ccc; padding: 20px; border-radius: 10px; position: relative; transition: all 0.3s ease; min-height: 120px; display: flex; flex-direction: column; justify-content: center; align-items: center;">
                        <div id="file-preview" style="margin-bottom: 10px;"></div>
                        <span id="file-name" style="display: block; margin: 5px 0; color: #666;"></span>
                        <div style="margin-top: 10px;">
                            <label for="file-upload" style="cursor: pointer; display: inline-block; margin: 0 5px;"
