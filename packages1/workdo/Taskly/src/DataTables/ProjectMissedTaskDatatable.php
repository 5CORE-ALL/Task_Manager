    ...
    public function query(Task $model)
{
    ...
    // Remove groupBy unless strictly necessary; groupBy can break ordering/filters.
    // If some duplicate rows appear because of joins, prefer distinct() instead:
    $task->groupBy('tasks.id'); // keep only if you have a valid reason
