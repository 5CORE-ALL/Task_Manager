...
use Workdo\Hrm\Http\Controllers\Api\DepartmentApiController;
use Workdo\Hrm\Http\Controllers\Api\EmployeeApiController;
...
Route::prefix('Hrm')->group(function () {
    ...
    Route::get('get-departments',[DepartmentApiController::class,'index']);
    Route::get('get-employees',[EmployeeApiController::class,'index']);
